...
# Paramètres de la stratégie (en pips)
SL_PIPS = int(os.getenv("SL_PIPS", "30"))
TP1_PIPS = int(os.getenv("TP1_PIPS", "30"))
TP2_PIPS = int(os.getenv("TP2_PIPS", "90"))
TP3_PIPS = int(os.getenv("TP3_PIPS", "120"))
TP4_PIPS = int(os.getenv("TP4_PIPS", "150"))   # un peu plus loin, optionnel
ENTRY_OFFSET_PIPS = int(os.getenv("ENTRY_OFFSET_PIPS", "10"))
...
# --------------------- 3. CONSTRUCTION DU SIGNAL (en pips) ---------------------
...
if __name__ == "__main__":
    print("🚀 Bot XAUUSD (Davo 30/90/120) démarré...")
    try:
        requests.post(
            f"https://api.telegram.org/bot{TOKEN}/sendMessage",
            json={"chat_id": CHAT_ID, "text": "✅ Bot Davo réglé (SL 30pips, TP 30/90/120) en ligne !"}
        )
    except:
        pass
